...
def inject_workspace_styles() -> None:
    ...
    <style>
      ...
      [data-testid="stHeader"] { background:rgba(10,14,21,.82); border-bottom:1px solid var(--line-soft); height:2.75rem; }
      ...
      .block-container { max-width:1390px; padding:1.05rem 2.4rem 4rem; }
      ...
      [class*="st-key-nav_"] button { border:0; background:transparent; text-align:left; box-shadow:none; color:#9aa8ba; min-height:2.55rem; padding:.42rem .62rem; font-size:.80rem; font-weight:590; border-radius:8px; }
      ...
      [class*="st-key-nav_"] button::before { display:inline-grid; place-items:center; width:1.32rem; height:1.32rem; margin-right:.62rem; border:1px solid #304b6c; border-radius:5px; color:#bcd6ff; background:#101d2d; font-size:.75rem; line-height:1; vertical-align:-.12rem; }
      ...
      .va-topbar { display:flex; align-items:center; justify-content:space-between; gap:1rem; padding:.1rem 0 .78rem; border-bottom:1px solid var(--line-soft); }
      ...
      .va-workflow-row { margin:0 0 1.15rem; }
      [class*="st-key-workflow_"] button { min-height:2rem; padding:.22rem .18rem; border:0; border-bottom:2px solid #2b3647; border-radius:0; background:transparent; color:var(--faint); font-size:.67rem; text-align:center; box-shadow:none; }
