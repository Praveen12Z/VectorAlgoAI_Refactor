...
CATALOG = [
    _item("VA-001", "EMA reclaim with momentum confirmation", "Trend continuation", "NAS100", "1h",
        ...
        ["EMA20 > EMA50; prior close <= prior EMA20 and current close > current EMA20; RSI14 > 50.",
         ...
         "Current baseline models entry at signal close and uses the engine's indicator conventions. This is an execution approximation; it is not a next-open simulation."],
        ...
        [], "Whipsaws; signal-close fills may be optimistic; gaps and changing costs.",
